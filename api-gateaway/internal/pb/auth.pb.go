...
func (x *GoogleLoginResponse) GetUser() *AuthUser {
	if x != nil {
		return x.User
	}
	return nil
...
const file_auth_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"auth.proto\x12\x04auth\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x84\x02\n" +
	"\bAuthUser\x12\x1a\n" +
	...
	"\x04user\x18\x01 \x01(\v2\x0e.auth.AuthUserR\x04user\x12!\n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage2\xe2\x04\n" +
	"\vAuthService\x12W\n" +
	...
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/auth/login\x12d\n" +
	"\vGoogleLogin\x12\x18.auth.GoogleLoginRequest\x1a\x19.auth.GoogleLoginResponse\" \x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/v1/auth/google_login\x12h\n" +
	"\fRefreshToken\x12\x19.auth.RefreshTokenRequest\x1a\x1a.auth.RefreshTokenResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/auth/refresh_token\x12s\n" +
	"\x15SendVerificationEmail\x12\x18.auth.VerifyEmailRequest\x1a\x19.auth.VerifyEmailResponse\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1/auth/send_verification\x12h\n" +
	"\fConfirmEmail\x12\x19.auth.ConfirmEmailRequest\x1a\x1a.auth.ConfirmEmailResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/auth/confirm_emailB-Z+e-commerce-microservice/proto-shared/gen/pbb\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	13, // 0: auth.AuthUser.created_at:type_name -> google.protobuf.Timestamp
	13, // 1: auth.AuthUser.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 2: auth.RegisterResponse.user:type_name -> auth.AuthUser
	0,  // 3: auth.LoginResponse.user:type_name -> auth.AuthUser
	0,  // 4: auth.GoogleLoginResponse.user:type_name -> auth.AuthUser
