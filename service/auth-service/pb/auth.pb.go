...
var file_pb_auth_proto_depIdxs = []int32{
	...
	2, // 2: auth.AuthService.LoginWithGoogle:input_type -> auth.GoogleLoginRequest
	3, // 3: auth.AuthService.Register:output_type -> auth.AuthResponse
	3, // 4: auth.AuthService.Login:output_type -> auth.AuthResponse
	3, // 5: auth.AuthService.LoginWithGoogle:output_type -> auth.AuthResponse
