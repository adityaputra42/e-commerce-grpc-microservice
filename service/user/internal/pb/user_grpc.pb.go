...
type UserServiceClient interface {
	...
	CreateAddress(ctx context.Context, in *CreateAddressRequest, opts ...grpc.CallOption) (*UserAddressResponse, error)
	UpdateAddress(ctx context.Context, in *UpdateAddressRequest, opts ...grpc.CallOption) (*UserAddressResponse, error)
	GetAddresses(ctx context.Context, in *GetUserAddressesRequest, opts ...grpc.CallOption) (*UserAddressesResponse, error)
}
...
func (c *userServiceClient) CreateAddress(ctx context.Context, in *CreateAddressRequest, opts ...grpc.CallOption) (*UserAddressResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) UpdateAddress(ctx context.Context, in *UpdateAddressRequest, opts ...grpc.CallOption) (*UserAddressResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserAddressResponse)
...
func (c *userServiceClient) GetAddresses(ctx context.Context, in *GetUserAddressesRequest, opts ...grpc.CallOption) (*UserAddressesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserAddressesResponse)
...
type UserServiceServer interface {
	...
	CreateAddress(context.Context, *CreateAddressRequest) (*UserAddressResponse, error)
	UpdateAddress(context.Context, *UpdateAddressRequest) (*UserAddressResponse, error)
	GetAddresses(context.Context, *GetUserAddressesRequest) (*UserAddressesResponse, error)
...
func (UnimplementedUserServiceServer) CreateAddress(context.Context, *CreateAddressRequest) (*UserAddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAddress not implemented")
}
func (UnimplementedUserServiceServer) UpdateAddress(context.Context, *UpdateAddressRequest) (*UserAddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateAddress not implemented")
}
func (UnimplementedUserServiceServer) GetAddresses(context.Context, *GetUserAddressesRequest) (*UserAddressesResponse, error) {
...
func _UserService_GetAddresses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetAddresses(ctx, req.(*GetUserAddressesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
